...
# conditionally — only when this invocation started or rebooted the guest (and, even then, only
# if get_windows_autologon_configured says autologon is set) — once, at the end of its own
# flow — not something reboot_windows_guest_and_wait itself does.
